...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 20-02-2023 a las 16:23:48
...
CREATE TABLE `detalle_de_pedido` (
  ...
  `envio` varchar(45) COLLATE utf8_bin DEFAULT NULL,
  `fecha` datetime DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_bin;
...
(6014, NULL, NULL, 'En proceso', 301051, ''),
(6015, NULL, NULL, 'En proceso', 301053, NULL),
...
CREATE TABLE `pqrs` (
  ...
  `encargado_res` varchar(50) COLLATE utf8_bin DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_bin;
...
(9058, 'Ruana Capota Cafe', 'unisex', 77000, 'Activo', 2, 'ruana-capota-cafe-3.jpg');
...
--
ALTER TABLE `detalle_de_pedido`
  MODIFY `id_detalle_pedido` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=8181;

--
-- AUTO_INCREMENT de la tabla `envios`
--
ALTER TABLE `envios`
  MODIFY `id_envio` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=6062;
...
--
ALTER TABLE `roles_usuarios`
  MODIFY `id_rol_usuario` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2068;
...
--
ALTER TABLE `venta`
  MODIFY `id_venta` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=301129;
