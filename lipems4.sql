...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 10-03-2023 a las 18:26:50
...
(8016, 1, 18000, 18000, 9016, 4014, 'Error en la venta', '', NULL, NULL, 'f@f.com', NULL, NULL),
...
(8170, 1, 40000, 47600, 9010, 4034, 'Activo', 'si', '2023-02-16 11:14:18', 7014, NULL, NULL, NULL),
...
(8236, 1, 32000, 38080, 9015, 4075, 'Activo', 'si', '2023-03-09 16:07:02', NULL, NULL, 2, 26),
(8237, 1, 20000, 23800, 9014, 4076, 'Activo', 'si', '2023-03-09 16:11:42', NULL, NULL, 2, 27);
...
(26, NULL, '222', '2023-07', 123),
(27, NULL, '21222', '2023-06', 211);
...
(6016, '2023-02-23 10:59:00', '2023-03-10 07:27:34', 'Entregado', 8010, 'cooperativa'),
...
(6116, '2023-03-09 16:07:02', NULL, 'En proceso', 8236, NULL),
(6117, '2023-03-09 16:11:42', NULL, 'En proceso', 8237, NULL);
...
(4075, NULL, 8784646424, NULL),
(4076, NULL, 8784646424, NULL);
...
(9014, 'blusa blanca', 'mujer', 20000, 'Activo', 2, NULL),
(9015, 'camiseta de cuadros', 'hombre', 32000, 'Activo', 1, NULL),
(9016, 'buso pequeño', 'niño', 18000, 'Activo', 5, NULL),
...
INSERT INTO `usuarios` (`id_usuario`, `nombre`, `telefono`, `email`, `direccion`, `password`, `reset_password_token`, `imagen`) VALUES
...
(8784646424, 'f', 1234, 'f@f.com', 'f12', '$2a$10$lqNAhPkmRd3mfIaTb2x3WeYR437ZLBKsxSGXMRDTA1ecxmYutIgCG', NULL, 'perfil.jpg'),
...
--
ALTER TABLE `detalle_de_pedido`
  MODIFY `id_detalle_pedido` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=8238;

--
-- AUTO_INCREMENT de la tabla `detalle_transaccion`
--
ALTER TABLE `detalle_transaccion`
  MODIFY `id_detalle_transaccion` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=28;

--
-- AUTO_INCREMENT de la tabla `envios`
--
ALTER TABLE `envios`
  MODIFY `id_envio` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=6118;
...
--
ALTER TABLE `pedido`
  MODIFY `id_pedido` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4077;
...
--
ALTER TABLE `roles_usuarios`
  MODIFY `id_rol_usuario` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2089;
